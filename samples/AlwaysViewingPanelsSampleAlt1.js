enyo.kind({
	...
	kind: "moon.Panel",
	// title: "Second Panel aaa bbb ccc ddd eee fff ggg",
	title: "Second Panel",
	headerOptions: {
		kind: "moon.Header",
	...
	// handlers: {
	// 	// onTransitionComplete:	"myPreTransitionComplete",
	// 	onPostTransitionComplete:	"attachRecords"
	// },
	// create: function () {
...
enyo.kind({
	...
	components: [
		{
			title: "First Panel", 
			// title: "First Panel which is also really quite long", 
			titleBelow:"Sub-title", subTitleBelow:"Sub-sub title", classes: "moon-7h",
			components: [
